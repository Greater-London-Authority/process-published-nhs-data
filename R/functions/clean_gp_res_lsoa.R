...
clean_gp_res_lsoa <- function(dir_in,
  ...
  fp_gp_lsoa_male <- list.files(dir_in, pattern = "gp-reg-pat-prac-lsoa-male.csv", full.names = TRUE)
  fp_gp_lsoa_female <- list.files(dir_in, pattern = "gp-reg-pat-prac-lsoa-female.csv", full.names = TRUE)
