...
download_nhs_month_legacy_format <- function(dt_yyyy_mm,
                               dir_save,
                               base_url = "https://digital.nhs.uk/data-and-information/publications/statistical/patients-registered-at-a-gp-practice/",
                               link_pattern = "gp_syoa|gp-reg-patients-prac-sing-year-age|lsoa-alt-format-tall|gp-reg-patients-lsoa-alt-tall|-lsoa-alt-tall",
